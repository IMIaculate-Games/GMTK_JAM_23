using UnityEngine;
public abstract class Mob_Test : MonoBehaviour, Attackable
{
    ...
    [SerializeField]
    protected MobData_Test mobData;
    ...
    protected Soldier_Test opponentSoldier = null;

    public void SetIsFighting(bool value)
    {
        isFighting = value;
    }
    public Soldier_Test GetOpponent()
    {
        return opponentSoldier;
    }
    public void SetOpponent(Soldier_Test soldier)
    {
    ...
    public void Attack(Soldier_Test target)
    {
